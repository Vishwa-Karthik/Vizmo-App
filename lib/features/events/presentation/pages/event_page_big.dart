...
class EventPageBig extends StatefulWidget {
  const EventPageBig({super.key});

  @override
  State<EventPageBig> createState() => _EventPageBigState();
}

class _EventPageBigState extends State<EventPageBig> with EventTypeUtility {
